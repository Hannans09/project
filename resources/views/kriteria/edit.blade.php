            ...
            <form action="{{ route('kriteria.update', $kriteria->id) }}" method='post' enctype="multipart/form-data">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" name='nama' id="nama"
                        ...
                        placeholder=" " required value={{ $kriteria->nama }} />
                    <label for="nama"
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="number" name='bobot' id="bobot" step="0.01"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required value={{ $kriteria->bobot }} />
                    <label for="bobot"
                ...
                <fieldset class="relative z-0 w-full mb-6 group">
                    ...
                    <div
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="atribut" id="atribut1" value="benefit"
                                {{ $kriteria->atribut == 'benefit' ? 'checked' : '' }}>
